...
class FoodController {
    var foodItems: [FoodItem] = [
        ...
        FoodItem(name: "Beef Wraps", time: "05:00 PM", description: "Drop off at Dress Up For Success organization.", is_claimed: false, pickup_date: "\(Date().dateString())", organization_name: "Best Price Deli"),
        FoodItem(name: "Cupcakes", time: "07:30 PM", description: "We have 20 boxes.", is_claimed: false, pickup_date: "\(Date().dateString())", organization_name: "Baked by Melissa"),
        FoodItem(name: "Fruits", time: "07:30 PM", description: "5 platters.", is_claimed: false, pickup_date: "\(Date().dateString())", organization_name: "Best Price Deli"),
        FoodItem(name: "Sandwiches", time: "05:30 PM", description: "Bowery Mission requested this to be dropped off.", is_claimed: false, pickup_date: "\(Date().dateString())", organization_name: "Best Price Deli"),
        FoodItem(name: "Donuts", time: "05:30 PM", description: "Variety of donuts.", is_claimed: false, pickup_date: "\(Date().dateString())", organization_name: "Tompskin Square Bagel"),
        FoodItem(name: "Beef Brisket", time: "05:30 PM", description: "1 pound.", is_claimed: false, pickup_date: "\(Date().dateString())", organization_name: "Tompskin Square Bagel"),
        FoodItem(name: "Chicken Soup", time: "05:30 PM", description: "Half pot.", is_claimed: false, pickup_date: "\(Date().dateString())", organization_name: "Tompskin Square Bagel")
    ]
